<div>
    <div class="intro-y box mt-5">
                    ...
                    <div class="flex flex-col sm:flex-row ">
                        <div class="form-check mr-2">
                            <input id="radio-switch-4" class="form-check-input" type="radio"
                                wire:model="attributes.value" value="Passed">
                        ...
                        <div class="form-check mr-2 mt-2 sm:mt-0">
                            <input id="radio-switch-5" class="form-check-input" type="radio"
                                wire:model="attributes.value" value="Failed">
        ...
        <div id="radio"
            class=" grid grid-cols-2 md:grid-cols-3 gap-x-4 gap-y-6 border-b border-1 border-slate-400 p-5">
                ...
                <div class="preview ">
                    <div class="mt-3">
                        ...
                        <div class="flex flex-col sm:flex-row mt-2">
                            <div class="form-check mr-2">
                                <input id="radio-switch-4" class="form-check-input" type="radio"
                                    wire:model='attributes.{{ $key }}' value="Passed">
                                <label class="form-check-label" for="radio-switch-4">Passed</label>
                            </div>
                            <div class="form-check mr-2 mt-2 sm:mt-0">
                                <input id="radio-switch-5" class="form-check-input" type="radio"
                                    wire:model="attributes.{{ $key }}" value="Failed">
                                <label class="form-check-label" for="radio-switch-5">Failed</label>
                            </div>
                        </div>
                    </div>
