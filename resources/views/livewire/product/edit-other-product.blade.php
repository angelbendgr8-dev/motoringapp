        ...
        <div class="box p-5 rounded-md mt-5">
            ...
            <div class="flex items-center"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                    ...
                    <rect x="8" y="2" width="8" height="4" rx="1"
                        ry="1"></rect>
                </svg> Name: <p href="#" class=" capitalize decoration-dotted ml-1">{{ $product->name }}</p>
            </div>
            <div class="flex items-center mt-3"> <svg xmlns="http://www.w3.org/2000/svg" width="24"
                ...
                </svg> Description: <p href="#" class=" capitalize decoration-dotted ml-1">
                ...
                <div class="intro-y col-span-12 sm:col-span-6 2xl:col-span-4">
                    <div class="box">
                        ...
                        <div
                            ...
                            <a wire:click='deleteImage({{ $key }})' class="flex items-center text-danger"
                                href='#' data-tw-target="#delete-confirmation-modal"> <svg
