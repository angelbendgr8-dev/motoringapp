<div class="flex justify-center mt-8 md:mt-24">
    <div class="intro-y box p-12 w-[100%] md:w-[50%]">
        <h1 class="text-center text-3xl font-semibold my-4">Add User</h1>

        <div class="mt-4"> <label for="regular-form-1" class="form-label"> Name</label>
        ...
        <div class="mt-4"> <label for="regular-form-1" class="form-label"> Email</label>
            <input wire:model='email' type="text"
                class="form-control border border-slate-200 rounded-md  @error('email') border-red-300 @enderror"
                placeholder=" Email">
            @error('email')
                <div class="clear-right">
                    <p class="float-right text-red-400">{{ $message }}</p>
        ...
        <div class="mt-4"> <label for="regular-form-1" class="form-label">Password</label>
            <input wire:model='password' type="text"
                class="form-control border border-slate-200 rounded-md  @error('password') border-red-300 @enderror"
        ...
        <div class="mt-4"> <label for="regular-form-1" class="form-label">User Type</label>
            <select wire:model='type'
                class="form-control  border-1 rounded-md  border-slate-200 @error('type') border-red-300 @enderror">
        ...
        <div class="flex justify-center items-center mt-10">
            <button wire:click='addUser' class="btn btn-primary w-32 mr-2 mb-2">
                <div>
                    ...
                    <span wire:loading wire:target='addUser' class="text-white">
                                ...
                                <g transform="translate(1 1)">
                                    ...
                                    <circle cx="49" cy="50" r="5" fill="white">
                                        <animate attributeName="cy" begin="0s" dur="2.2s"
                                            values="50;50;5;50" calcMode="linear" repeatCount="indefinite"></animate>
