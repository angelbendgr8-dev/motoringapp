<div>
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{route('admin.add.location')}}" class="btn btn-primary shadow-md mr-2">Add New Location</a>
            <div class="dropdown">
            ...
            <table class="table table-report -mt-2">
                ...
                <tbody>
                    @forelse ($locations as $location)
                        <tr class="intro-x">
                            <td class="w-40">
                                <a href="" class="font-medium whitespace-nowrap">{{ $location->state }}</a>
                            </td>
                            <td>
                                <a href="" class="font-medium whitespace-nowrap">{{ $location->area }}</a>
                            ...
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    <a class="flex items-center mr-3"
                                        href="{{ route('admin.edit.location', $location->id) }}"> <svg
                                    ...
                                    <a class="flex items-center text-danger" href="#"
                                        wire:click='deleteLocation({{ $location->id }})'> <svg
                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
