<div class="flex justify-center mt-8 md:mt-24">
    <div class="intro-y box p-12 w-[100%] md:w-[50%]">
        <h1 class="text-center text-3xl font-semibold my-4">Edit Location</h1>

        <div> <label for="regular-form-1" class="form-label">State</label>
            <input wire:model='location.state' type="text"
                class="form-control border border-slate-200 rounded-md  @error('location.state') border-red-300 @enderror"
        ...
        <div class="mt-3">
            ...
            <input wire:model='location.area' id="regular-form-2" type="text" placeholder="Area/Local government"
                class="form-control border border-slate-200 rounded-md  @error('location.area') border-red-300 @enderror"
               />
            @error('location.area')
                <div class="clear-right">
                    <p class="float-right text-red-400">{{$message}}</p>
        ...
        <div class="mt-3">
            ...
            <input wire:model='location.address' id="regular-form-7" type="text"
                class="form-control border border-slate-200 rounded-md  @error('location.address') border-red-300 @enderror" placeholder="Process1, Process2, process3">
